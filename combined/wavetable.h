...
class Wavetable
{
  ...
  private:
    ...
    std::array<float, 8> phases;                  // the phase value of each oscillator
    std::array<float, 8> indicies;                // the wave index of each oscillator

    std::array<uint8_t, 8> notes;                 // the note of each oscillator
    std::array<uint8_t, 8> ages;                  // the age index of each oscillator
};
